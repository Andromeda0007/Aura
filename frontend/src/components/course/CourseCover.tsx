...
export const COVERS: Record<string, { gradient: string; Icon: LucideIcon; label: string }> = {
  database: { gradient: "from-indigo-500 to-violet-600", Icon: Database, label: "Database" },
  network: { gradient: "from-sky-500 to-cyan-600", Icon: Network, label: "Network" },
  ...
  science: { gradient: "from-fuchsia-500 to-purple-600", Icon: Atom, label: "Science" },
  ...
  world: { gradient: "from-blue-500 to-indigo-600", Icon: Globe, label: "Humanities" },
